...
module.exports.init = function(app, opts) {
  ...
  app.set('stormpathSessionDuration', opts.sessionDuration || parseInt(process.env.STORMPATH_SESSION_DURATION,10) || 1000 * 60 * 30);
  app.set('stormpathSessionActiveDuration', opts.sessionActiveDuration || parseInt(process.env.STORMPATH_SESSION_ACTIVE_DURATION,10) || 1000 * 60 * 5);
  app.set('stormpathSessionDomain', opts.sessionDomain || process.env.STORMPATH_SESSION_DOMAIN || undefined);
  app.set('stormpathSessionPath', opts.sessionPath || process.env.STORMPATH_SESSION_PATH || '/');
  app.set('stormpathSessionTTL', opts.sessionTTL || parseInt(process.env.STORMPATH_SESSION_TTL, 10) || 3600);
  app.set('stormpathSessionTTI', opts.sessionTTI || parseInt(process.env.STORMPATH_SESSION_TTI, 10) || 900);
  app.set('stormpathSessionHTTPOnly', opts.sessionHTTPOnly || (process.env.STORMPATH_SESSION_HTTP_ONLY === 'true') || true);
  ...
  app.set('stormpathCachePort', opts.cachePort || parseInt(process.env.STORMPATH_CACHE_PORT,10) || undefined);
  app.set('stormpathCacheTTL', opts.cacheTTL || parseInt(process.env.STORMPATH_CACHE_TTL,10) || 300);
  app.set('stormpathCacheTTI', opts.cacheTTI || parseInt(process.env.STORMPATH_CACHE_TTI,10) || 300);
  ...
  // Oauth configuration.
  app.set('stormpathOauthTTL', opts.oauthTTL || parseInt(process.env.STORMPATH_OAUTH_TTL,10) || 3600);
  ...
  // Angular settings for client-side stuff.
  app.set('stormpathAngularPath', opts.angular && opts.angular.appPath);

  // Authentication system options
  app.set('stormpathAccessTokenCookieName', opts.accessTokenCookieName || 'access_token');
