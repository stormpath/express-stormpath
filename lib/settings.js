...
module.exports.init = function(app, opts) {
  ...
  app.set('stormpathEnableConfirmPassword', getValue(
    [ opts.enableConfirmPassword, process.env.STORMPATH_ENABLE_CONFIRM_PASSWORD ],
    opts.enableConfirmPassword || (process.env.STORMPATH_ENABLE_CONFIRM_PASSWORD === 'true'),
    true
  ));
  ...
  app.set('stormpathRequireConfirmPassword', getValue(
    [ opts.requireConfirmPassword, process.env.STORMPATH_REQUIRE_CONFIRM_PASSWORD ],
    opts.requireConfirmPassword || (process.env.STORMPATH_REQUIRE_CONFIRM_PASSWORD === 'true'),
    true
  ));
