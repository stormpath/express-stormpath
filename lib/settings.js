...
module.exports.init = function(app, opts) {
  ...
  app.set('stormpathPasswordChangeView', opts.passwordChangeView || process.env.STORMPATH_PASSWORD_CHANGE_VIEW || __dirname + '/views/change.jade');
  ...
  // Since forgot_complete.jade applies to a regular password change as well, stormpathPasswordCompleteView defaults to stormpathForgotPasswordCompleteView.
  app.set('stormpathPasswordCompleteView', opts.passwordCompleteView || process.env.STORMPATH_PASSWORD_COMPLETE_VIEW || app.get('stormpathForgotPasswordCompleteView'));
