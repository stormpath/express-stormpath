...
module.exports.initSettings = function(app, opts) {
  return function(next) {
    ...
    app.set('stormpathEnableForgotPasswordChangeAutoLogin', opts.enablePasswordChangeAutoLogin || (process.env.STORMPATH_ENABLE_PASSWORD_CHANGE_AUTO_LOGIN === 'true') || false);
