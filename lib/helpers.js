 ...
 */
module.exports.setTempCookie = function (res, name, value, maxAge) {
  if (maxAge === undefined) {
    maxAge = 60 * 5;
  }
 ...
 */
module.exports.prepAccountData = function(formData, callback) {
  if (!formData) {
  ...
  var coreFields = ['username', 'email', 'password', 'passwordConfirm', 'givenName', 'middleName', 'surname', 'status'];
  formData.customData = {};
