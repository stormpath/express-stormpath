...
module.exports.initSettings = function(app, opts) {
  return function(next) {
    ...
    app.set('stormpathSessionMiddleware', opts.sessionMiddleware || false);
    ...
    app.set('stormpathPostLogoutUrl', opts.postLogoutUrl || process.env.STORMPATH_POST_LOGOUT_URL || '/');
