...
module.exports.googleLogin = function(req, res) {
  if (!req.query.code) {
    helpers.render(req, res, req.app.get('stormpathGoogleLoginFailedView'));
...
module.exports.facebookLogin = function(req, res) {
  if (!req.query.access_token) {
    helpers.render(req, res, req.app.get('stormpathFacebookLoginFailedView'));
  ...
  req.app.get('stormpathApplication').getAccount(userData, function(err, resp) {
    ...
    // Generate a new session -- this creates a JWT / session cookie.
