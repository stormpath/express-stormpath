      ...
      async.waterfall([
        ...
        if (!err && !req.app.get('stormpathEnableAccountVerification')) {
          if (req.app.get('stormpathPostRegistrationHandler')) {
            req.app.get('stormpathPostRegistrationHandler')(res.locals.user, res, function() {
...
module.exports.login = function(req, res) {
  ...
  if (res.locals.user && req.app.get('stormpathEnableAutoLogin')) {
    return res.redirect(302, req.app.get('stormpathRedirectUrl'));
  }
