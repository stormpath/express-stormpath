...
module.exports.register = require('./controllers/register');
module.exports.login = require('./controllers/login');
...
module.exports.verifyEmail = require('./controllers/verify-email');

module.exports.forgotPassword = require('./controllers/forgot-password');

module.exports.changePassword = require('./controllers/change-password');
 ...
 * @param {Object} res - The http response.
 */
module.exports.linkedinLogin = function(req, res) {
