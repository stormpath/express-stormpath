...
/**
 * Allow a user to change his password after he/she logged in.
 *
 * The URL this controller is bound to, and the view used to render this page
 * can all be controlled via express-stormpath settings.
 *
...
module.exports.change = function (req, res) {
  ...
  helpers.getUser(req, res, function () {
    var user = req.user;
    forms.changeOldPasswordForm.handle(req, {
...
/**
 * This controller renders a page to confirm that password change is completed
 *
 * @method
 *
 * @param {Object} req - The http request.
