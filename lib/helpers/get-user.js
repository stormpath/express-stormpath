...
module.exports = function (req, res, next) {
  ...
  if (cookies && cookies.idSiteSession) {
    var accountHref = cookies.idSiteSession;
    ...
    client.getAccount(accountHref, function (err, account) {
      ...
      if (account.status !== 'ENABLED') {
        logger.info('Account for idSiteSession cookie is not ENABLED.');
        return next();
      }
  ...
  } else if (cookies && cookies.access_token) {
