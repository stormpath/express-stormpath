...
var accountTransform = require('../okta/account-transform');
 ...
 */
module.exports = function (authenticationResult, oktaUser, req, res) {
  res.locals.user = req.user = accountTransform(oktaUser);
