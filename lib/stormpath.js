...
module.exports.init = function (app, opts) {
  ...
  client.on('ready', function () {
    ...
    // TODO: Serve our assets (currently stormpath.min.js). This is just temporary used during dev.
    // Using the /assets/ route will likely conflict with customer environments.
