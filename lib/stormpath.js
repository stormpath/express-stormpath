...
module.exports.init = function(app, opts) {
  ...
  if (config.web.login.enabled) {
    if (config.web.idSite.enabled) {
      ...
      router.post(config.web.login.uri, controllers.login);
    }
  }
  ...
  if (config.web.forgotPassword.enabled) {
    ...
    router.use(config.web.changePassword.nextUri, urlMiddleware);
    router.use(config.web.forgotPassword.nextUri, urlMiddleware);
    ...
    router.get(config.web.changePassword.nextUri, controllers.forgotChangeDone);

    router.get(config.web.forgotPassword.uri, controllers.forgot);
    router.post(config.web.forgotPassword.uri, controllers.forgot);
    router.get(config.web.forgotPassword.nextUri, controllers.forgotSent);
  }
