...
module.exports.init = function(app, opts) {
  ...
  if (app.get('stormpathEnablePasswordChange')) {
    ...
    router.get(app.get('stormpathPasswordChangeUrl'), controllers.change);
    router.post(app.get('stormpathPasswordChangeUrl'), controllers.change);
    router.get(app.get('stormpathPostPasswordChangeRedirectUrl'), controllers.changeDone);
  }
