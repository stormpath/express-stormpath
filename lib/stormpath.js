...
var AccessTokenAuthenticator = require('./okta/access-token-authenticator.js');
...
module.exports.init = function (app, opts) {
  ...
  client.on('ready', function () {
    ...
    for (var providerName in config.web.social) {
      ...
      if (provider.enabled) {
        addGetRoute(provider.uri, controllers.idpLogin.bind(null, provider));
      }
    }
...
module.exports.AccessTokenAuthenticator = AccessTokenAuthenticator;
module.exports.initClient = initClient;
module.exports.JwtAuthenticator = stormpath.JwtAuthenticator;
module.exports.expandAccount = helpers.expandAccount;
module.exports.StormpathAccessTokenAuthenticator = stormpath.StormpathAccessTokenAuthenticator;
module.exports.OAuthRefreshTokenGrantRequestAuthenticator = stormpath.OAuthRefreshTokenGrantRequestAuthenticator;
