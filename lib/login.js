...
function loginWithOAuthProvider(options, req, res) {
  ...
  application.getAccount(options, function(err, providerAccountResult) {
    ...
    helpers.createIdSiteSession(providerAccountResult.account, req, res);
...
module.exports = function login(req, res) {
  ...
  if (req.method === 'POST' && accepts === 'json') {
    if (req.body.providerData) {
      ...
      var options = {
        providerData: {
          providerId: req.body.providerData.providerId,
          accessToken: req.body.providerData.accessToken,
          code: req.body.providerData.code
        }
      };

      loginWithOAuthProvider(options, req, res);
    } else {
