...
missing_body += 'But, we do not have this email address on file. ';
...
function sendEmail(to_email, subject, reset_link, token_lifetime, IP_ADDRESS, USER_AGENT, callback) {
  ...
  var token_lifetime_hours = token_lifetime / 60;
  opts.body = {
    key: api_key,
    ...
    message: {
      ...
      global_merge_vars: [
        ...
        {
          name: 'reset_window',
          content: token_lifetime_hours
        },
        {
          name: 'reset_window_units',
          content: token_lifetime_hours > 1 ? 'hours' : 'hour'
        },
        {
          name: 'ip_address',
          content: IP_ADDRESS
