        ...
        forms.changePasswordForm.handle(req, {
          ...
          success: function (form) {
            ...
            result.save(function (err) {
              ...
              if (req.headers['user-agent'].indexOf('Rooster') == -1 && !helpers.allowBrowser(req, res))
                return helpers.render(req, res, view, {status: "success-in-browser", form: form});
          ...
          error: function (form) {
            ...
            if (form.data && !form.data.password && !form.data.passwordAgain) {
              return helpers.render(req, res, view, { form: form, action: action });
            }
