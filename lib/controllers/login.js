    ...
    'application/json': function () {
      switch (req.method) {
        ...
        case 'POST':
          ...
          helpers.authenticate(req.body, req, res, function (err, account, authResult) {
            if (err) {
              return helpers.writeJsonError(res, err);
            }

            helpers.loginResponder(authResult, account, req, res);
          });
          break;
    ...
    'text/html': function () {
      ...
      forms.loginForm.handle(req, {
        ...
        success: function (form) {
          helpers.authenticate(form.data, req, res, function (err, account, authResult) {
            if (err) {
