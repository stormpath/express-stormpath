...
function applyDefaultAccountFields(config, req) {
  var registerFields = config.web.register.fields;

  if (registerFields.givenName && !registerFields.givenName.enabled && !req.body.givenName) {
    req.body.givenName = 'Anonymous';
  }

  if (registerFields.surname && !registerFields.surname.enabled && !req.body.surname) {
