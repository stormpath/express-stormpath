...
function applyDefaultAccountFields(stormpathConfig, req) {
  ...
  if (!registerFields.givenName || !registerFields.givenName.required && !req.body.givenName) {
    req.body.givenName = 'UNKNOWN';
  }

  if (!registerFields.surname || !registerFields.surname.required && !req.body.surname) {
